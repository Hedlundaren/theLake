...
public:
	...
	void updateCubeMapUniforms(MouseRotator rotator, float width, float height, float time, glm::vec3 clear_color, const int side);
	void updateMirrorUniforms(MouseRotator rotator, float width, float height, float time, glm::vec3 clear_color);
